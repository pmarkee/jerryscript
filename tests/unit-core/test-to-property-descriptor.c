...
{
  jerry_property_descriptor_t prop_desc = jerry_make_empty_property_descriptor ();
...
main (void)
{
  ...
  TEST_ASSERT ((prop_desc.flags & JERRY_PROP_IS_GET_DEFINED) == 0);
  TEST_ASSERT ((prop_desc.flags & JERRY_PROP_IS_SET_DEFINED) == 0);
  ...
  TEST_ASSERT ((prop_desc.flags & JERRY_PROP_IS_VALUE_DEFINED) == 0);
  TEST_ASSERT ((prop_desc.flags & JERRY_PROP_IS_GET_DEFINED) == 0);
  TEST_ASSERT ((prop_desc.flags & JERRY_PROP_IS_SET_DEFINED) == 0);
  TEST_ASSERT (prop_desc.flags & JERRY_PROP_IS_WRITABLE_DEFINED);
  TEST_ASSERT ((prop_desc.flags & JERRY_PROP_IS_WRITABLE) == 0);
  TEST_ASSERT ((prop_desc.flags & JERRY_PROP_IS_ENUMERABLE_DEFINED) == 0);
  TEST_ASSERT (prop_desc.flags & JERRY_PROP_IS_CONFIGURABLE_DEFINED);
  TEST_ASSERT (prop_desc.flags & JERRY_PROP_IS_CONFIGURABLE);
  ...
  TEST_ASSERT ((prop_desc.flags & JERRY_PROP_IS_VALUE_DEFINED) == 0);
  TEST_ASSERT ((prop_desc.flags & JERRY_PROP_IS_WRITABLE_DEFINED) == 0);
  ...
  TEST_ASSERT ((prop_desc.flags & JERRY_PROP_IS_SET_DEFINED) == 0);
  TEST_ASSERT (prop_desc.flags & JERRY_PROP_IS_ENUMERABLE_DEFINED);
  TEST_ASSERT ((prop_desc.flags & JERRY_PROP_IS_ENUMERABLE) == 0);
  TEST_ASSERT ((prop_desc.flags & JERRY_PROP_IS_CONFIGURABLE_DEFINED) == 0);
  ...
  TEST_ASSERT (prop_desc.flags & JERRY_PROP_IS_ENUMERABLE);
  TEST_ASSERT (prop_desc.flags & JERRY_PROP_IS_CONFIGURABLE_DEFINED);
  TEST_ASSERT ((prop_desc.flags & JERRY_PROP_IS_CONFIGURABLE) == 0);
