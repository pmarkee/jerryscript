...
jerry_make_empty_property_descriptor (void)
{
  ...
  return prop_desc;
} /* jerry_make_empty_property_descriptor */
                                   ...
                                   jerry_property_descriptor_t *prop_desc_p) /**< property descriptor */
{
  ...
  if ((prop_desc_p->flags & JERRY_PROP_IS_WRITABLE_DEFINED) == 0 || (prop_desc.flags & ECMA_PROP_IS_WRITABLE) == 0)
  {
